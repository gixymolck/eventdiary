                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="dob-cal">
                                    <input id="dob" type="text" class="form-control mb-4 datepicker @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required autocomplete="dob" autofocus data-provide="datepicker">
                                    <span class="fa fa-calendar dob_calendar" aria-hidden="true "></span>
                                </div>
                                @error('dob')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
